...
#SBATCH --job-name=t1-prompt-generation         # Name of the job
...
BASE_SCRIPT="plan-bench/finetune_prompt_generator.py"

srun -N1 -n1 python3 $BASE_SCRIPT --task all --config blocksworld_3 --ignore_existing --verbose False
